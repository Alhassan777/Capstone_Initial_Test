...
function Woman(props) {
  ...
  useEffect(() => {
    if (names[animationIndex]) {
      ...
      return () => {
        // Add safety check before calling fadeOut
        if (actions && names[animationIndex] && actions[names[animationIndex]]) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <CharacterController model={group.current} animations={animations} />
      <group name="Scene">
